<nav class="min-h-screen w-full max-w-[250px] overflow-y-scroll">

    <div class="mt-5 space-y-5 p-3 text-sm font-semibold text-slate-800">
        ...
        <x-accordion title="Games" :open="true">
